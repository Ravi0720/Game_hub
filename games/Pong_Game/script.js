 <script>
        ...
        canvas.addEventListener('touchmove', (e) => {
            ...
            if (gameMode === 'single') {
                    leftPaddle.y = Math.max(0, Math.min(canvas.height - leftPaddle.height, touchY - leftPaddle.height / 2));
            } else {
                if (touch.clientX < rect.width / 2) {
                    leftPaddle.y = Math.max(0, Math.min(canvas.height - leftPaddle.height, touchY - leftPaddle.height / 2));
                } else {
                    rightPaddle.y = Math.max(0, Math.min(canvas.height - rightPaddle.height, touchY - rightPaddle.height / 2));
                }
            }
        });
